...
`black-hole-sun` is an extension of the [Jungle](https://github.com/nicksenger/Jungle) "workflow-as-type" (WAT) event-replay orchestration framework that conducts blackbox co-optimization of multi-agent systems.

It runs on a custom engine which currently supports only GGUF quantized models of the Qwen3.* architecture (e.g. Qwen3.8-27b, Qwen3-Next).
