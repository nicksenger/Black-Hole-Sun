//! Render a black-hole-beam JSON piano score to a 16-bit PCM WAV file.
...
#[command(
    ...
    version,
    about = "Render a black-hole-beam JSON piano score to stereo pcm_s16le WAV"
)]
struct Args {
    /// JSON piano score to render
    input: PathBuf,
